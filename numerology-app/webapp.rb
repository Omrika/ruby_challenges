...
def get_msg (birth_num)
	...
	when 3
		message = 'Number Three is a sociable, friendly, and outgoing vibration. Kind, positive, and optimistic, Three enjoy life and have a good sense of humor. Ruled by Jupiter.'
	when 
